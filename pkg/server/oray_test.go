...
func TestOrayEndpoint(t *testing.T) {
	...
	t.Run("Oray URL format with Basic Auth", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?hostname=test.example.com&myip=1.2.3.4", nil)
	...
	t.Run("Oray URL format with embedded credentials", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?user=testuser&pass=testpass&hostname=test.example.com&myip=1.2.3.4", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray parameter names - myip", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?user=testuser&pass=testpass&hostname=test.example.com&myip=192.168.1.1", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray auto-detect IP from RemoteAddr", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?user=testuser&pass=testpass&hostname=test.example.com", nil)
	...
	t.Run("Oray return code: badauth (wrong password)", func(t *testing.T) {
		req := httptest.NewRequest("GET", "/ph/update?user=testuser&pass=wrongpassword&hostname=test.example.com&myip=1.2.3.4", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray return code: badauth (unknown user)", func(t *testing.T) {
		req := httptest.NewRequest("GET", "/ph/update?user=unknownuser&pass=anypass&hostname=test.example.com&myip=1.2.3.4", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray return code: notfqdn (invalid domain)", func(t *testing.T) {
		req := httptest.NewRequest("GET", "/ph/update?user=testuser&pass=testpass&hostname=ab&myip=1.2.3.4", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray return code: notfqdn (missing domain)", func(t *testing.T) {
		req := httptest.NewRequest("GET", "/ph/update?user=testuser&pass=testpass&myip=1.2.3.4", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray return code: 911 (invalid IP)", func(t *testing.T) {
		req := httptest.NewRequest("GET", "/ph/update?user=testuser&pass=testpass&hostname=test.example.com&myip=invalid.ip.address", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray return code: good with IP", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?user=debug&pass=debug&hostname=test.example.com&myip=1.2.3.4", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray IPv6 support", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?user=debug&pass=debug&hostname=test.example.com&myip=2001:db8::1", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray with subdomain", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?user=debug&pass=debug&hostname=sub.example.com&myip=1.2.3.4", nil)
		w := httptest.NewRecorder()
	...
	t.Run("Oray Basic Auth preference over query params", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?user=wronguser&pass=wrongpass&hostname=test.example.com&myip=1.2.3.4", nil)
		req.SetBasicAuth("testuser", "testpass")
		w := httptest.NewRecorder()
...
func TestOrayProtocolCompatibility(t *testing.T) {
	...
	t.Run("Oray standard request format", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?hostname=oray.example.com&myip=203.0.113.100", nil)
	...
	t.Run("Oray request without myip parameter", func(t *testing.T) {
		...
		req := httptest.NewRequest("GET", "/ph/update?hostname=oray.example.com", nil)
		req.SetBasicAuth("orayuser", "oraypass")
